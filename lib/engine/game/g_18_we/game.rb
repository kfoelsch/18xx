    ...
    module G18WE
      class Game < Game::Base
        ...
        def add_marker(corporation)
          ...
          image = "18WE/#{corporation.id}".upcase.delete('&')
        ...
        def priority_deal_player
          ...
          if @round.is_a?(Engine::Game::G18WE::Round::Stock)
        ...
        def place_home_token(corporation)
          ...
          tile = hex.tile
          city = tile.cities.first # no OO tiles in 18WE
        ...
        def stock_round
          G18WE::Round::Stock.new(self, [
            G18WE::Step::BuyTokens,
            G18WE::Step::ForcedSales,
            G18WE::Step::BuySellParShares,
          ])
        end

        def operating_round(round_num)
          Engine::Round::Operating.new(self, [
            G18WE::Step::HomeUpgrade,
            G18WE::Step::OptionShare,
            G18WE::Step::RemoveTokens,
            G18WE::Step::Merge,
            G18WE::Step::Track,
            G18WE::Step::Token,
            G18WE::Step::Route,
        ...
        def new_parliament_round
          ...
          G18WE::Round::Parliament.new(self, [
            G18WE::Step::CharterAuction,
          ])
        end
